...
Minicart.prototype = {
    ...
    hideMessage: function() {
        $j(this.selectors.error).parents('.error-msg').fadeOut('slow');
        $j(this.selectors.success).parents('.success-msg').fadeOut('slow');
    },

    showError: function(message) {
        $j(this.selectors.error).text(message).parents('.error-msg').fadeIn('slow');
    },

    showSuccess: function(message) {
        $j(this.selectors.success).text(message).parents('.success-msg').fadeIn('slow');
    }
};
