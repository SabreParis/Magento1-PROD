...
$infos=
    <<<HTML
        <img src="{{skin url='images/product-infos-1.png'}}" alt="Passe au lave-vaisselle à basse temperature." />
        <img src="{{skin url='images/product-infos-2.png'}}" alt="Passe au lave-vaisselle à basse temperature." />
        <span class="text">
            Passe au lave-vaisselle<br/>à basse temperature.
        </span>
HTML;
