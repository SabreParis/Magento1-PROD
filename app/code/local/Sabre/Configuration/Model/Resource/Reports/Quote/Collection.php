...
/** AYaline alter function addCustomerData to fix Abandoned Cart collection for report=> Abandoned Cart grid  */

class Sabre_Configuration_Model_Resource_Reports_Quote_Collection extends Mage_Reports_Model_Resource_Quote_Collection
{
    /**
     * Add customer data
     *
     * aYaline alter joinInner to joinLeft so we can display shopping carts on report=> Abandoned Cart collection
     *
    ...
    public function addCustomerData($filter = null)
    {
        ...
        $this->getSelect()
            ...
            ->joinLeft( /* aYaline alter joinInner to  joinLeft */
