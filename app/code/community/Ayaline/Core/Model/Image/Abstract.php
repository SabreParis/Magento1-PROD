 ...
 */
abstract class Ayaline_Core_Model_Image_Abstract extends Mage_Core_Model_Abstract
{
     ...
     * @return string
     */
    abstract public function getBaseMediaPath();

    /**
     * Return placeholder config picture
     *
     * @return string
     */
    abstract public function getPlaceholderConfig();

    /**
     * Return skin placeholder base dir
     * only path, end with a /
     * ex: images/ayaline/news/news/placeholder/
     *
     * @return string
     */
    abstract public function getSkinPlaceholderPath();

    /**
     * Return media cache base dir
     * end with a /
     * ex: ayaline/news/news/cache/
     *
     * @return string
     */
    abstract public function getBaseMediaCachePath();
    ...
    public function setBaseFile($file)
    {
        ...
        if (!$file) {
            ...
            $isConfigPlaceholder = $this->getPlaceholderConfig();
            ...
            if ($isConfigPlaceholder && $this->_fileExists($baseDir . $configPlaceholder)) {
                ...
                $skinPlaceholder = DS . $this->getSkinPlaceholderPath() . "{$this->getDestinationSubdir()}.jpg";
        ...
        if ((!$file) || (!file_exists($baseFile))) {
            throw new Exception(Mage::helper('ayalinecore')->__('Image file was not found.'));
        }
...
//			}
    ...
    {
        $directory = $this->getBaseMediaCachePath();
