 ...
 */
class Ayaline_EnhancedAdmin_Block_Adminhtml_Widget_Grid_Renderer_Action_ViewFile extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
    ...
    protected function _toLinkHtml($action, Varien_Object $row)
    {
        ...
        $action['onclick'] = "return varienGridAction.getFileContent(this);";
