...
/**
 *  Postcodes form block
 *
 */
class Ayaline_Shop_Block_Adminhtml_Shop_Edit_Tab_Postcodes extends Mage_Adminhtml_Block_Widget
{

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('ayaline/shop/edit/tab/postcodes.phtml');
    }
    ...
    {
        return $this->getStore()->getPostcodes();
    }
