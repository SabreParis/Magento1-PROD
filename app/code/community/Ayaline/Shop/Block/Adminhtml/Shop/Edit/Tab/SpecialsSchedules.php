...
/**
 *  Store schedules form block
 *
 */
class Ayaline_Shop_Block_Adminhtml_Shop_Edit_Tab_SpecialsSchedules extends Mage_Adminhtml_Block_Widget
{

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('ayaline/shop/edit/tab/specials-schedules.phtml');
    }
    ...
    public function getSpecialsSchedules()
    {
        return $this->getShop()->getSpecialsSchedules(true);
    }
